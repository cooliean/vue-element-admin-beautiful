...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    append: function append(data, level) {
      if (1 === level) {
        id++;
        var newChild = {
          id: id,
